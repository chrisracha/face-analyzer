...
if __name__ == '__main__':
    try:
        ...
        try:
            ...
            if hasattr(controller, 'ocr_window') and controller.ocr_window and hasattr(controller.ocr_window, 'cap') and controller.ocr_window.cap:
                controller.ocr_window.cap.release()
            if hasattr(controller, 'face_window') and controller.face_window and hasattr(controller.face_window, 'cap') and controller.face_window.cap:
